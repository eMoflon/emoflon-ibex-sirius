...
final class Saver extends TransactionalEditingDomainListenerImpl {
	 ...
	 *            the session to save.
	 */
	Saver(CustomDAnalysisSessionImpl session) {
	...
	/**
	 * Do saving after transaction closing in case the SavingPolicy trigger another
	 * transaction by executing a EMF Command.
	 */
	@Override
	...
	private boolean transactionInProgress() {
		if (session.getTransactionalEditingDomain() instanceof InternalTransactionalEditingDomain) {
			InternalTransaction tx = ((InternalTransactionalEditingDomain) session.getTransactionalEditingDomain())
