...
class SessionResourcesTracker {
     ...
     */
    SessionResourcesTracker(CustomDAnalysisSessionImpl session) {
     ...
     */
    static void manageAutomaticallyLoadedResources(final CustomDAnalysisSessionImpl session, List<Resource> knownResources) {
