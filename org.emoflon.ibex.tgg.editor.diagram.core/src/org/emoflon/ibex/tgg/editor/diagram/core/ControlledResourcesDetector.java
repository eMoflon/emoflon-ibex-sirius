...
public class ControlledResourcesDetector extends ResourceSetListenerImpl {
     ...
     */
    public ControlledResourcesDetector(CustomDAnalysisSessionImpl session) {
     ...
     */
    static void refreshControlledResources(CustomDAnalysisSessionImpl session) {
    ...
    private static class RefreshControlledResourcesCommand extends RecordingCommand {
        ...
        RefreshControlledResourcesCommand(CustomDAnalysisSessionImpl session) {
